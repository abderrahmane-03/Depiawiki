...
<body class="bg-gray-100">
    <div class="flex flex-col h-screen bg-gray-100">
                            ...
                            <div class="mt-8">
                                <div class="flex flex-wrap space-x-0 space-y-2 md:space-x-4 md:space-y-0">
                                    <div class="flex-1 bg-white p-4 shadow rounded-lg md:w-1/2">
                                        ...
                                        <span class=" flex justify-between py-2 px-8 bg-grey-lightest font-bold uppercase
                                            text-l text-grey-light ">
                                            <?= $Tag['nameTag']; ?>
                                            <div class="flex">
                                                <p class="px-4">id:<?= $Tag['idTag']; ?>
                                                </p>
                                                <form method="post">
        ...
        <div id="addModal" class="fixed inset-0 bg-gray-900 bg-opacity-50 hidden items-center flex justify-center">
            <div class="bg-white p-8 rounded shadow-lg w-96">
                ...
                <form id="addForm" action="../controller/Tag.php" method="post">
                    ...
                    <button type="submit" name="addTag" class="bg-cyan-500 text-white px-4 py-2 rounded">Add
                        Tag</button>
        ...
        <div id="editModal"
            ...
            <div class="bg-white p-8 rounded shadow-lg w-96">
                <h2 class="text-2xl font-bold mb-4">edite Tag</h2>
